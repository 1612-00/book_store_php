...
<body>
	<div class="container-fluid" style="background-color: black;">
		...
		<div class="col-sm-10" style="background-color: #eee">
			...
			<h3 class="mb-4 mt-4 text-center">Danh sách đơn đăng ký làm diễn giả:</h3>
			...
			<div class="container-fluid row">
				...
				<div class="col-sm-5 mb-3">
					<form class="d-flex justify-content-between">
						...
						<div class="d-flex">
							<input id="search_theme" class="form-control me-2" type="search" placeholder="Search" aria-label="Search">
			...
			<table class="table table-bordered">
			  <thead>
			    <tr>
			      ...
			      <th scope="col">Chủ đề đăng ký</th>	
			      <th scope="col">Đã liên lạc</th>
			      <th></th>      
			    </tr>
			  </thead>
			  <tbody id="listSpeaker">
			  	<?php $i = 1 ?>
			  	<?php foreach ($arr as $value): ?>
				    <tr>
				    	<th scope="row"><?php echo $i++ ?></th>
				    	<td><img src="<?php echo $value["avatar"] ?>" alt="avatar" width="80px" height="80px"></td>
				      ...
				      <td>
				      	<a href="descSpeaker.php?id=<?php echo $value["id"] ?>" class="btn btn-outline-success">Chi tiết</a>
				      </td>
				    </tr>
			    <?php endforeach ?>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$("#search_theme").keyup(function() {
			var input = $("#search_theme").val();

			$.ajax({
				url: 'ajax_search_speaker.php',
				type: 'POST',
				data: {
					input: input
				},
